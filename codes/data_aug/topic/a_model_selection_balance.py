...
data_path = '../../../dataset/input_topic.csv' 

best_para_path = '../../paper_replication/topic/best_para.txt'
...
def model_init():
    return RobertaForSequenceClassification.from_pretrained(checkpoint, problem_type= "single_label_classification",num_labels=32).to('cuda')
...
def model_selection(output_dir, aug_label_ratio, aug_to):
    ...
    for train_idx, test_idx in kf_1.split(ds_1['train']):
        ...
        for train_idx, val_idx in kf_2.split(train_set_1):
            ...
            train_2 =  balance_swap_flexible(train_1,aug_label_ratio=aug_label_ratio, aug_to = aug_to)
...
def main(): 
    for aug_label_ratio in [0.05,0.1,0.15,0.2,0.25,0.3]:
        folder_path = 'swap_' + str(aug_label_ratio) + '_' + str(round(1-aug_label_ratio,1)) + '/'
        output_dir='../../../models/data_aug/topic/' + folder_path
