...
def get_perfomance(m):
    ...
    for n in range(1,11):
        model_path =  "../../../models/data_aug/topic/"+m+"/bm_" + str(n)
        model = RobertaForSequenceClassification.from_pretrained(model_path, problem_type= "single_label_classification", num_labels=32).to("cuda")
...
def get_all():
    #all_model_path = ["all_0.1_0.9","all_0.3_0.7","all_0.5_0.5","all_0.7_0.3",'all_0.9_0.1']
    all_model_path = ["syn_0.05_0.95","syn_0.1_0.9","syn_0.2_0.8"]
