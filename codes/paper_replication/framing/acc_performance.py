...
for n in range(1,11):
    model_path = "../../../models/paper_rep/framing/bm_" + str(n)
    model = RobertaForSequenceClassification.from_pretrained(model_path, problem_type= "single_label_classification", num_labels=15)
