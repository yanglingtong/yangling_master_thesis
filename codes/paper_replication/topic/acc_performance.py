...
kf_1 = KFold(n_splits=k, random_state=42, shuffle=True)
for train_idx, test_idx in kf_1.split(ds['train']):
    test_idx_list.append(test_idx)
    
for n in range(1,11):
    model_path =  "../../../models/paper_rep/topic/bm_" + str(n)
    model = RobertaForSequenceClassification.from_pretrained(model_path, problem_type= "single_label_classification", num_labels=32)
