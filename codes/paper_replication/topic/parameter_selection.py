...
output_dir='../../../models/paper_rep/topic/'
...
def model_init():
    return RobertaForSequenceClassification.from_pretrained(checkpoint, problem_type= "single_label_classification",num_labels=32)
